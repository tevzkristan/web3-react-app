...
function Navbar() {
  function navSlide() {
    ...
    burger.addEventListener('click', () => {
      ...
      nav.classList.toggle('nav-active'); // Use toggle instead of add
    });
  ...
  // Call navSlide inside useEffect or componentDidMount to ensure the element is available when the component mounts.
  React.useEffect(() => {
    navSlide();
  }, []);
